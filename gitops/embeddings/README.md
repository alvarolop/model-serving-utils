...
```sh
DATA_SCIENCE_PROJECT_NAMESPACE=embeddings
RUNTIME_MODEL_ID="nomic-embed-text-v1-gpu"
INFERENCE_URL=$(oc get inferenceservice/${RUNTIME_MODEL_ID} -n ${DATA_SCIENCE_PROJECT_NAMESPACE} -o jsonpath='{.status.url}')
echo ${INFERENCE_URL}
